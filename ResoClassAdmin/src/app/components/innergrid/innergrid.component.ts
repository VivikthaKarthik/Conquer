...
import { InneractionCellRendererComponent } from '../inneraction-cell-renderer/inneraction-cell-renderer.component';
import { Router } from '@angular/router';
import { DynamicbuttoncellrenderComponent } from '../dynamicbuttoncellrender/dynamicbuttoncellrender.component';

@Component({
  selector: 'app-innergrid',
  templateUrl: './innergrid.component.html',
  styleUrl: './innergrid.component.css'
})
  ...
  ngOnInit(): void {
    ...
    if (!this.showAnalysis) {
      this.gridColumns.push({
        ...
        resizable: false,
        filter: false,
        cellRenderer: InneractionCellRendererComponent,
        cellRendererParams: {
